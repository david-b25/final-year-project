  ...
  return (
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 sm:p-10">
        ...
        {inputAttrs.name === "image" || inputAttrs.name === "logo" || inputAttrs.name === "favicon" || inputAttrs.name === "openGraph"   ? (
          <Uploader
        ...
        ): inputAttrs.name === "buttonRadius" || inputAttrs.name === "componentRadius" ? (
          <div className="flex max-w-sm items-center overflow-hidden rounded-lg border border-stone-600">
            <select
              name={inputAttrs.name}
              defaultValue={inputAttrs.defaultValue}
            ...
            >
              ...
              <option value="two-extra-large">Two Extra Large</option>
        ...
        ) : inputAttrs.name === "description" || inputAttrs.name === "metaDescription" ? (
          <textarea
            {...inputAttrs}
            rows={3}
            required
