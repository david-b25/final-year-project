...
export default function Uploader({
  ...
  name: "image" | "logo" | "favicon" | "openGraph";
}) {
  
  const aspectRatio = (name === "image" || name === "openGraph") ? "aspect-video" : "aspect-square";
  ...
  const handleUpload = (file: File | null) => {
    if (file) {
      ...
      if (file.size / 1024 / 1024 > 50) {
        ...
        toast.error("Invalid file type (must be .png, .jpg, .jpeg, or .mp4)");
      } else {
    ...
    <div>
      ...
      >
        ...
        {data[name] && (
          ...
          <img
            src={fileType?.includes("mp4") ? "/empty-state.png" : data[name] as string}
            alt="Preview"
