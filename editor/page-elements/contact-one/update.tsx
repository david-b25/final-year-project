...
const propertiesSchema = z.object({
    ...
    linkTitles: z.object({
        ...
        textThree: z.string().min(2).max(50),
        textColourThree: z.string().min(7).max(7),
    }).optional(),
...
export function Update({
    ...
    const form = useForm<propertiesFormSchemaType>({
        ...
        defaultValues: {
            ...
            linkTitles: element.extraAttributes.linkTitles,
    ...
    function applyChanges(values: propertiesFormSchemaType){
        const { image, backgroundColour, tagline, title, paragraph, linkTitles, links } = values;
        ...
        <div>
            <Accordion type="single" collapsible className="w-full pb-4  text-stone-600 text-xs">
                ...
                <Form {...form}>
                    ...
                    >
                    <AccordionItem value="backgroundColour">
                    ...
                    <AccordionTrigger>Heading Fields</AccordionTrigger>
                    <AccordionContent className="px-2 grid grid-cols-1 md:grid-cols-1 gap-2 place-items-center">
                        <TextAndColour 
                            label="Tagline"
                            control={form.control}
                    ...
                    <AccordionItem value="linkHeading">
                    <AccordionTrigger>Links Headings</AccordionTrigger>
                    <AccordionContent className="px-2 grid grid-cols-1 md:grid-cols-1 gap-2 place-items-center">
                        <TextAndColour 
                            label="Tagline"
                            control={form.control}
                            text="linkTitles.textOne"
                            textColour="linkTitles.textColourOne"
                        />

                        <TextAndColour 
                            label="Title"
                            control={form.control}
                            text="linkTitles.textTwo"
                            textColour="linkTitles.textColourTwo"
                        />

                        <TextAndColour 
                            label="Paragraph"
                            control={form.control}
                            text="linkTitles.textThree"
                            textColour="linkTitles.textColourThree"
                        />
                    ...
                    <AccordionContent className="px-2 grid grid-cols-1 md:grid-cols-1 gap-2 place-items-center">
                        <TextAndColour 
                            ...
                            control={form.control}
                            text="links.textOne"
                            textColour="links.textColourOne"
                        />
                        ...
                        <TextAndColour 
                            ...
                            control={form.control}
                            text="links.textTwo"
                            textColour="links.textColourTwo"
                        />

                        <TextAndColour 
                            label="Link Three"
                            control={form.control}
                            text="links.textThree"
                            textColour="links.textColourThree"
                        />
